  ...
  const sortedReserved = useMemo(
    () =>
      [...appointments].sort((a, b) =>
        a.date.trim().slice(0, 10).localeCompare(b.date.trim().slice(0, 10))
      ),
    [appointments]
  );
    ...
    <div className="space-y-6">
      ...
      {!readOnly && (
        <div className="space-y-4">
          <div>
            <h3 className="text-base font-semibold">Reserve a slot</h3>
            <p className="text-sm text-muted-foreground">
              Pick a day on the calendar to see available clinics.
            </p>
          </div>
          ...
          {selectedDate ? (
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          past ? "cursor-not-allowed opacity-60" : "hover:bg-muted/50"
                        )}
                        onClick={() => {
            ...
            <p className="text-sm text-muted-foreground">Select a day to reserve a slot.</p>
          )}
