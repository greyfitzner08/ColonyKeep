      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            can keep the current record, replace it, or merge fields. Imported volunteers must still
            open and accept the liability waiver and policy on first login, even if the CSV marks
            them signed. Roles Requested should use role labels like &quot;Trapper&quot; or
