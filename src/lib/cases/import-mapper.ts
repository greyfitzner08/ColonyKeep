...
const HEADER_ALIASES: Record<string, string> = {
  ...
  colony_street_address: "colony_street_address",
...
const LEGACY_STATUS_MAP: Record<string, HelpRequestStatus> = {
  ...
  trapping: "claimed",
  trapped: "appointment_reserved",
  transported: "appointment_reserved",
  "checked in": "appointment_reserved",
  checked_in: "appointment_reserved",
  complete: "completed",
  completed: "completed",
  closed: "closed",
  resolved: "closed",
