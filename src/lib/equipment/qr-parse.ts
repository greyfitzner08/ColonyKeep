...
const TYPE_ALIASES: Record<string, TrapEquipmentType> = {
  ...
  set_over_trap: "set_over_trap",
  set_over: "set_over_trap",
  "set-over": "set_over_trap",
  setover: "set_over_trap",
  spring_load_trap: "spring_load_trap",
  spring_load: "spring_load_trap",
  springload: "spring_load_trap",
