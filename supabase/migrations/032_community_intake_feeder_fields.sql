-- Persist colony feeder contact fields from public intake submissions.
...
BEGIN
  ...
  VALUES (
    ...
    COALESCE(rec.reported_kittens_under_8_weeks, rec.kittens_under_8_weeks, 0),
    COALESCE(rec.reported_cats_over_8_weeks, rec.cats_over_8_weeks, 0),
